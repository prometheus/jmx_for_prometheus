...
allowedlistObjectNames: ["org.apache.cassandra.metrics:*"]
deniedlistObjectNames: ["org.apache.cassandra.metrics:type=ColumnFamily,*"]
rules:
...
allowedlistObjectNames | A list of [ObjectNames](http://docs.oracle.com/javase/6/docs/api/javax/management/ObjectName.html) to query. Defaults to all mBeans.
deniedlistObjectNames | A list of [ObjectNames](http://docs.oracle.com/javase/6/docs/api/javax/management/ObjectName.html) to not query. Takes precedence over `allowedlistObjectNames`. Defaults to none.
